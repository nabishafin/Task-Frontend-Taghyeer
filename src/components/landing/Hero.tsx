...
export function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-white text-slate-900 overflow-hidden border-b border-slate-100">
      ...
      <div className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-[#00897b]/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[450px] h-[450px] bg-[#00897b]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#00897b]/15 border border-[#00897b]/40 text-[#00897b] text-xs font-bold shadow-2xs">
              <Zap className="w-4 h-4 text-[#00897b] animate-pulse" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-2">
              <Link
                href="/chat"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 text-sm font-extrabold text-white bg-[#00897b] hover:bg-[#00796b] px-7 py-4 rounded-2xl shadow-lg shadow-[#00897b]/30 transition-all hover:scale-105"
              >
            ...
            <div className="pt-3 flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs text-slate-500 font-semibold">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-[#00897b]" /> Socket.io Bidirectional
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-[#00897b]" /> Group Admin Control
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-[#00897b]" /> Smart Auto-Scroll
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md bg-white border border-slate-200/90 rounded-3xl p-5 shadow-2xl shadow-slate-900/10 backdrop-blur-xl space-y-4">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                      Pioneers Group
                      <Badge variant="accent" size="sm" className="bg-[#00897b]/20 text-[#00897b] border-[#00897b]/40 text-[9px]">
                        Group
                      </Badge>
                    </h4>
                    <p className="text-[10px] text-[#00897b] font-semibold flex items-center gap-1">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#00897b] animate-ping" />
                      3 Members Active
                    </p>
                  </div>
                </div>
                ...
                <Link
                  href="/chat"
                  className="px-2.5 py-1 rounded-xl bg-[#00897b]/15 border border-[#00897b]/30 text-[10px] font-bold text-[#00897b] hover:bg-[#00897b]/25 transition-colors"
                >
                  Join Live Chat →
                </Link>
              </div>
              ...
              <div className="space-y-3 min-h-[210px] bg-slate-50/70 p-3 rounded-2xl border border-slate-100">
                {HERO_DEMO_MESSAGES.slice(0, activeMessageCount).map((msg, idx) => (
                  ...
                  >
                    ...
                    >
                      {msg.text}
                      <span className={`block text-[9px] text-right mt-1 opacity-70 ${msg.isSelf ? 'text-white' : 'text-slate-400'}`}>
                        {msg.time}
                      </span>
                    </div>
                  </div>
              ...
              <div className="pt-1 flex items-center gap-2">
                <Link
                  href="/chat"
                  className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-400 flex items-center justify-between hover:border-[#00897b] transition-colors"
                >
                  <span>Type a message in Pulse...</span>
                  <MessageSquare className="w-3.5 h-3.5 text-[#00897b]" />
                </Link>
                <Link
                  href="/chat"
                  className="w-9 h-9 rounded-xl bg-[#00897b] text-white font-bold flex items-center justify-center shadow-md shadow-[#00897b]/30 shrink-0 hover:bg-[#00796b] transition-all"
                >
                  <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
